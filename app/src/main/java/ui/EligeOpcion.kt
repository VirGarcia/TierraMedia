...
class EligeOpcion : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val btnVerFestivos = findViewById<Button>(R.id.btnVerFestivos)
        ...
        // Añadimos el listener para el botón Ver Festivos
        btnVerFestivos.setOnClickListener {
            //Crear el intent para iniciar VerFestivos
            val intent = Intent(this, VerFestivos::class.java)
            startActivity(intent)
        }
