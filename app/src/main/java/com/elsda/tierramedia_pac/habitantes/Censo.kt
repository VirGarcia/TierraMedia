...
class Censo {
    ...
    fun generarHabitante(raza: String): HabitanteTierraMedia {
        ...
        // El festivo dentro del array de festivos
        val festivo = Festivo().festivos.random()

        return HabitanteTierraMedia(nombre, apellidos, edad, raza, ubicacion, profesion, festivo)
    }
